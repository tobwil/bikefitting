...
| Full vs Lite | Lite default; Full optional | Lite: lower latency, weaker distal landmarks (wrist/foot). Full: better joint stability, more GPU/CPU. **Re-measure on a real Mac** — not claimed here |
